...
Invoke-MsBuild -Path "$env:MODULE_NAME.sln" -MsBuildParameters "/p:Configuration=Release /p:Platform=Win32 /m" -BypassVisualStudioDeveloperCommandPrompt -ShowBuildOutputInCurrentWindow
Pop-Location
